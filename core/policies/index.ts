 ...
 * SQLite-backed approval queue via node-sqlite3-wasm.
          * Slice 2: deny flow - reason field added, immutability enforced.
          *
          * NOTE: SQLite TEXT columns return null (not undefined) for missing values.
          * toApproval() normalizes null -> undefined so TypeScript optional fields
 * behave correctly and tests can use strict equality against undefined.
          */
...
export function resolveApproval(
          ...
          // Immutability: reject if not found or already resolved
